...
どうやって技術書を読めばいいんだ？というひよこエンジニアの方もいるかもしれません。
このスライドの後半部分には@<code>{書評記事の書き方}の話が出てきます。それがすごく参考になるので、ここで紹介します。

普通は本を読み終わったら書評を書くと思うのですが、このスライドの作者は@<b>{書評記事の骨組みを先に作成してから}本を読んでいます。
技術同人誌を書くときには「目次ができたら80％完成したも同然」と言われています。これと同様に、先にアウトラインを作ってしまってから
そこに当てはまるトピックを探しながら本を読んでいくわけです。

こうすれば、受け身の読書から脱却できますね。書評を書くので、本の内容を噛み砕いて説明する必要があります。
